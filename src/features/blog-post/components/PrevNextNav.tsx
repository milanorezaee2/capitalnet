    ...
    >
      ...
      {prev ? (
        <button
          ...
          aria-label={`مقاله قبلی: ${prev.title}`}
        >
          <ChevronRight
            size={20}
          ...
          <div className="min-w-0">
            <p className="text-[11px] text-white/35 mb-1 font-medium">مقاله قبلی</p>
      ...
      {next ? (
        <button
          ...
          aria-label={`مقاله بعدی: ${next.title}`}
        >
          <ChevronLeft
            size={20}
            className="flex-shrink-0 mt-0.5 text-teal-400 group-hover:text-teal-300 transition-colors"
          ...
          />
          <div className="min-w-0">
            <p className="text-[11px] text-white/35 mb-1 font-medium">مقاله بعدی</p>
            <p className="text-sm font-semibold text-white/80 group-hover:text-white transition-colors line-clamp-2 leading-snug">
              {next.title}
            </p>
